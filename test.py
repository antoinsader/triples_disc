...
def create_silver_spans(descs, triples, relations, aliases, buid_logger,golden_triples_file, silver_spans_file, bert_tokenizer):
    ...
    cache_array(silver_spans, "./draft_silver_spans_old.pkl")
    cache_array(golden_triples, "./draft_golden_triples_old.pkl")
...
if __name__ == "__main__":
    ...
    create_silver_spans(descs,triples,relations, aliases , buid_logger,golden_triples_file, silver_spans_file , bert_tokenizer=tokenizer)